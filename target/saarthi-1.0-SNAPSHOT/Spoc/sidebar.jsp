...
<%
    Spoc spoc = (Spoc) session.getAttribute("current-user");
%>
  <!-- Navbar -->
    <nav class="navbar navbar-dark bg-dark fixed-top">
        ...
        <a class="navbar-brand mx-auto d-lg-none" href="#">Spoc Dashboard</a>
    </nav>
    ...
    <nav id="sidebar">
        <div class="sidebar-header text-center">
            ...
            <img src="../img/spocPhoto/<%= spoc.getPhoto()%>" alt="Admin" class="img-fluid">
            <h4 class="text-white"><%= spoc.getName()%></h4>
        </div>
